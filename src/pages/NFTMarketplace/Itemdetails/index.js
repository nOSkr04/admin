                            ...
                            <Row className="g-4">
                                ...
                                <Col lg={8}>
                                    <div>
                                        ...
                                        <span className="badge badge-soft-primary mb-3 fs-12"><i className="ri-eye-line me-1 align-bottom"></i> 8,634 people views this</span>
                                                        ...
                                                        <div className="mt-3">
                                                                ...
                                                                <Col>
                                                                    <div className="p-2">
                                                                        <div className="progress animated-progress progress-sm">
                                                                            <div className="progress-bar bg-priamry" role="progressbar" style={{ width: "50.16%" }} aria-valuenow="50.16" aria-valuemin="0" aria-valuemax="100"></div>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                                <Col className="col-auto">
                                                            ...
                                                            <Row className="align-items-center g-2">
                                                                ...
                                                                <Col>
                                                                    <div className="p-2">
                                                                        <div className="progress animated-progress progress-sm">
                                                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: "19.32%" }} aria-valuenow="19.32" aria-valuemin="0" aria-valuemax="100"></div>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                                <Col className="col-auto">
